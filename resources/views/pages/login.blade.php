    ...
    <div class="relative z-10 flex flex-col justify-center items-center px-4 pb-12">
        ...
        <form action="{{ url('/login') }}" method="POST" class="w-full max-w-md space-y-4 md:space-y-5">
            ...
            <div class="flex flex-col">
                ...
                <input type="tel" name="no_hp" placeholder="Masukkan nomor handphone anda"
            ...
            <div class="pt-4 space-y-3">
                <button type="submit"
                    class="w-full bg-[#2d4a22] hover:bg-[#1e3516] text-white font-bold py-3.5 rounded-full transition-all shadow-md active:scale-95">
                    Masuk
                </button>
            ...
            <div class="text-center pt-2">
                <a href="#" class="text-xs md:text-sm text-gray-500 hover:text-green-800 transition-colors">Lupa
                    Password?</a>
            </div>
        </form>
    </div>
